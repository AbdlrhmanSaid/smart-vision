      ...
      <div className="container mx-auto max-w-[1200px]">
        <div>
          <h2 className="text-[clamp(2rem,3.5vw,3rem)] font-bold mb-3">
            Smart Vision{" "}
            <span className="bg-linear-to-r from-[#a855f7] to-[#ec4899] bg-clip-text text-transparent">
              Engineers.
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {teamData.map((member, index) => (
            <div
              key={index}
              className="bg-[#0b0f19] rounded-2xl p-6 shadow-[0_10px_30px_rgba(0,0,0,0.3)] transition-transform duration-300 hover:scale-105 group"
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-[1.1rem] text-white mb-1 group-hover:text-[#a855f7] transition-colors">
                    {member.name}
                  </h3>
