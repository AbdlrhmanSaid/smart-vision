...
const IdeaAbout = () => {
  return (
    <section className="relative min-h-screen flex items-center bg-cover bg-center bg-no-repeat py-20" style={{ backgroundImage: "url('/WhatsApp Image 2026-04-13 at 5.32.42 PM.jpeg')" }} id="About">
      ...
      <div className="container mx-auto px-[22px] max-w-[1200px] relative z-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        {/* Left: Text */}
        <div>
          <span className="inline-block text-[#22d3ee] text-sm border border-[#22d3ee] px-3 py-1 rounded-full">AI-POWERED LOGISTICS</span>

          <h1 className="mt-6 text-[clamp(2.4rem,4vw,3.75rem)] font-bold text-white leading-[1.1]">
            Smart Warehouse <br />
            <span className="bg-gradient-to-r from-[#22d3ee] to-[#a855f7] bg-clip-text text-transparent">Controller</span>
          </h1>

          <p className="mt-6 text-[#d1d5db] max-w-[32rem] leading-relaxed text-lg">
          ...
          <div className="flex gap-4 mt-8">
            <button className="bg-[#22d3ee] text-black px-6 py-3 rounded-lg font-semibold transition-all hover:scale-105 hover:bg-[#67e8f9]">Explore System</button>
            <button className="bg-[#1f2937] text-white px-6 py-3 rounded-lg font-semibold transition-all hover:scale-105 hover:bg-[#374151]">Watch Demo</button>
          </div>
        </div>
        ...
        <div className="relative bg-[#111827]/70 backdrop-blur-md p-4 rounded-2xl shadow-2xl overflow-hidden group">
          ...
          <span className="absolute top-3 right-4 font-bold text-[#38bdf8] text-lg">OPTIMIZED</span>
