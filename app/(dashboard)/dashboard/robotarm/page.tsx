      ...
      {error ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            rounded-xl bg-primary text-background text-xs font-bold
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-3xl p-6">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                على زر التخزين ليوجه الذراع بوضع المنتج الموجود في المنطقة
                الثابتة داخل هذا الرف.
              </p>
            </div>
          </div>
                    ...
                    <div className="flex flex-col items-center gap-3 text-center mt-4">
                      {isOccupied ? (
                        <>
                          ...
                          <div>
                            <p className="font-bold text-foreground capitalize leading-tight">
                              {product}
                            </p>
